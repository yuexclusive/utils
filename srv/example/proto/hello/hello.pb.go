...
var file_proto_hello_hello_proto_rawDesc = []byte{
	...
	0x1c, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x72,
	0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x72, 0x65, 0x73, 0x32, 0x30, 0x0a,
	0x05, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x27, 0x0a, 0x04, 0x53, 0x65, 0x6e, 0x64, 0x12, 0x0e,
...
var file_proto_hello_hello_proto_depIdxs = []int32{
	0, // 0: hello.hello.Send:input_type -> hello.Request
	1, // 1: hello.hello.Send:output_type -> hello.Response
...
func (c *helloClient) Send(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (*UnimplementedHelloServer) Send(context.Context, *Request) (*Response, error) {
...
func _Hello_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloServer).Send(ctx, in)
	}
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServer).Send(ctx, req.(*Request))
	}
